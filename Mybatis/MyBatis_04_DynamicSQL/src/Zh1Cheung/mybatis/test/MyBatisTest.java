package Zh1Cheung.mybatis.test;
...
import Zh1Cheung.mybatis.dao.EmployeeMapperDynamicSQL;
...
import Zh1Cheung.mybatis.dao.DepartmentMapper;
import Zh1Cheung.mybatis.dao.EmployeeMapper;
import Zh1Cheung.mybatis.dao.EmployeeMapperAnnotation;
import Zh1Cheung.mybatis.dao.EmployeeMapperPlus;
...
public class MyBatisTest {
	...
	public void test() throws IOException {
		...
		try {
			Employee employee = openSession.selectOne(
					"Zh1Cheung.EmployeeMapper.selectEmp", 1);
			System.out.println(employee);
		} finally {
			openSession.close();
		}
	...
	public void test03() throws IOException{
		...
		try{
			...
			//测试修改
			//Employee employee = new Employee(1, "Tom", "jerry@qq.com", "0");
